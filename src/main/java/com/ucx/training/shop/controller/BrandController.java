...
public class BrandController {
    ...
    @GetMapping("/paged")
    public List<Brand> findAllPaged(@RequestParam int pageNumber, @RequestParam int pageSize) throws ResponseException {
        try {
            Page<Brand> brandPage = brandService.findAllPaged(pageNumber, pageSize);
