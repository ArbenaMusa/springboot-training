...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Assassins Creed', null, 56.5, 1, 1);
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'MORTAL KOMBAT', null, 49.5, 2, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Battlefield 4', null, 35, 3, 1);
INSERT INTO file_upload
VALUES (nextval('public.file_upload_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'jpg', 'bf4-cover.jpg',
        'D:\springboot-training/upload/bf4-cover.jpg', currval('public.product_id_seq'));
COMMIT;

BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Hitman 2', null, 9.99, 4, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'GTA V', null, 45.99, 5, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'DIRT', null, 35, 6, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Black Ops 2', null, 7.5, 7, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Modern Warfare 3', null, 12.5, 1, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Spider-Man', null, 65, 2, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'PES 2019', null, 22, 3, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Super Mario Bros 3', null, 32, 4, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Halo 4', null, 5, 5, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Fifa 19', null, 25, 6, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Battlefield V', null, 43, 7, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Man of Medan', null, 34, 1, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Batman Arkham Knight', null, 27, 2, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Cyberpunk 2077', null, 67, 3, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'GTA IV', null, 8, 4, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Injustice 2', null, 53, 5, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Wolfenstein', null, 67, 6, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Star Wars', null, 51, 7, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Assassins Creed Rogue', null, 8, 2, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'The Witcher 3', null, 30, 4, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Mortal Kombat 9', null, 29, 3, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Deus Ex: Mankind Divided', null, 47.99,
        3, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Resident Evil 2', null, 15.99, 2, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Borderlands 3', null, 49.99, 1, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Dishonored 2', null, 30.50, 6, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Just Cause 4', null, 22, 4, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'DOOM', null, 19.99, 5, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Assassins Creed Odyssey', null, 59.99,
        5, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Shadow of Mordor: Middle Earth', null,
        30, 1, 1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Ghost Recon: Wildlands', null, 17, 7,
        1);
INSERT INTO file_upload
...
BEGIN;
INSERT INTO product
VALUES (nextval('public.product_id_seq'), now(), null, null, 'ACTIVE', null, 0, 'Kingdom Come: Deliverance', null, 14,
        2, 1);
INSERT INTO file_upload
